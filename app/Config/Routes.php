...
$routes->post('/admin/updatePetunjukPengisian/(:any)', 'Admin\Pernyataan::updatePetunjukPengisian/$1');
...
// responden
$routes->get('/responden/isiDataDiri/(:any)', 'Responden\DataDiri::isiDataDiri/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti, Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
$routes->post('/responden/updateDataDiri/(:any)', 'Responden\DataDiri::updateDataDiri/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti, Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
$routes->delete('/responden/deleteColumnDataDiri/(:any)', 'Responden\DataDiri::deleteColumnDataDiri/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti, Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);

$routes->get('/responden', 'Responden\Response::index', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti,Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
$routes->get('/responden/riwayatSurvei/(:any)', 'Responden\Response::riwayatSurvei/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti,Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
$routes->post('/responden/isiSurvei/(:any)', 'Responden\Response::isiSurvei/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti,Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
$routes->post('/responden/saveSurvei/(:any)', 'Responden\Response::saveSurvei/$1', ['filter' => 'role:Admin,Kontributor,Dosen,Tenaga Kependidikan,Mahasiswa,Alumni/Lulusan,Mitra,Partners,Peneliti,Pengabdi,Pengelola Keuangan Unit,Pengguna Lulusan']);
